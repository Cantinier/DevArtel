package ru.digitbreak.control.repository;

import ru.digitbreak.control.TenderControlApp;
import ru.digitbreak.control.config.Constants;
import ru.digitbreak.control.config.audit.AuditEventConverter;
import ru.digitbreak.control.domain.PersistentAuditEvent;
...
import static ru.digitbreak.control.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
